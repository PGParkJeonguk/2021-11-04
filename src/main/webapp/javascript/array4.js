...
// filter-> map(id,email,lastname,firstname) -> forEach
// 여회원 리스트
// 표형식으로 출력.
...
const newMemberList = filterData.map(function (val) {
    let newObj = {}
    newObj.id = val.id
...
let str = "<h3>여회원 리스트</h3>"
str += "<table border='1', color=red><thead>"
str += "<tr><th>ID</th><th>성</th><th>이름</th><th>이메일</th></thead>"
str += "<tbody>"
newMemberList.forEach(callbackFnc)
str += "<tbody>"
str += "</table>"
